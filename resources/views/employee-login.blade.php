            ...
            <!-- END: Toggle Theme -->
                  <div class="flex justify-center">
                    ...
                    <div class="space-y-1">
                        ...
                        <label class="form-control w-full">
                            <div class="label flex justify-end">
                              <span class="label-text font-medium text-[14px] text-gray-800 dark:text-white">کد ملی</span>
                            </div>
                        ...
                        <label class="form-control w-full">
                            <div class="label flex justify-end">
                              <span class="label-text font-medium text-[14px] dark:text-white">رمز عبور</span>
                            </div>
                            <input type="password" placeholder="اینجا رمز را وارد کنید" class="input text-right input-bordered w-full dark:bg-[#333333] dark:text-white" />
                        </label>
                    ...
                    <div class="flex gap-1 font-medium text-[12px] py-5 dark:text-white">
                      <span class="ms-1">رمز خود را فراموش کردید؟</span>
                    ...
                    <div>
                      <a href="index 2.html">
                          <button class="btn bg-[#3A5B22] w-full text-white">Login</button>
                      </a>
                    </div>
