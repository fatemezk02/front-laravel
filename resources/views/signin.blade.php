                  ...
                  <div class="flex justify-center">
                    ...
                    <div class="space-y-1">
                        ...
                        <label class="form-control w-full">
                            ...
                            <input type="password" placeholder="اینجا رشته را وارد کنید" class="input text-right input-bordered w-full dark:bg-[#333333] dark:text-white" />
                        </label>
